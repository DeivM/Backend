...
{
    [Authorize]
    public class CatalogoSeguimientoController : BaseApiController
    {
        private readonly ICatalogoSeguimientoService _CatalogoSeguimientoService;
        public CatalogoSeguimientoController(ICatalogoSeguimientoService CatalogoSeguimientoService)
        {
            _CatalogoSeguimientoService = CatalogoSeguimientoService;
        }
        ...
        [ResponseType(typeof(RespuestaModel<ListadoPaginadoModel<CatalogoSeguimientoModel>>))]
        [HttpGet]
        public async Task<IActionResult> GetAll( int quantity = 10, int page = 0, string orderby = "CasId", string ascdesc = "descending", string search = null)
        {
            var resultado = new RespuestaModel<ListadoPaginadoModel<CatalogoSeguimientoModel>>
            {
                Data = await _CatalogoSeguimientoService.GetAll(quantity, page, orderby, ascdesc, search)
            };
            return Ok(resultado);
        }
        ...
        [ResponseType(typeof(RespuestaModel<CatalogoSeguimientoData>))]
        [HttpGet]
        [Route("GetData")]

        public async Task<IActionResult> GetData(int id = 0)
        {
            var resultado = new RespuestaModel<CatalogoSeguimientoData>
            {
                Data = await _CatalogoSeguimientoService.GetData(id)
            };
        ...
        [HttpPost]
        public async Task<IActionResult> Post(CatalogoSeguimientoRequest data)
        {
            var resultado = new RespuestaModel<long?>
            {
                Data = await _CatalogoSeguimientoService.Add(data)
            };
            return Ok(resultado);
        }
        ...
        [HttpPut]
        public async Task<IActionResult> Update(int id, CatalogoSeguimientoRequest data)
        {
            data.CasId = id;
            var resultado = new RespuestaModel<long?>
            {
                Data = await _CatalogoSeguimientoService.Update(data)
            };
            return Ok(resultado);
        }
        ...
        public async Task<IActionResult> Delete(List<long> ids)
        {
            ...
            await _CatalogoSeguimientoService.Delete(ids);
            return Ok(resultado);    
        }
